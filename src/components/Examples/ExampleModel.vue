<template>
  <datepicker
    class="w-[320px] overflow-hidden rounded-md border bg-white px-2 pb-2 text-center text-gray-800 dark:border-neutral-800 dark:bg-neutral-800 dark:text-gray-300"
    v-model="date"
    :model-format="example.modelFormat"
    v-slot="{ days }"
  >
